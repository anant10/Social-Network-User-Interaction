...
# -----------------------------------------------------------
hadoop.root=/home/anantshanbhag/hadoop/hadoop-2.9.1
jar.name=mr-demo-1.0.jar
jar.path=target/${jar.name}
#job.name=allpairshortestpath.AllPairShortestPathRunner
job.name=shortestpath.SingleSourceShortestPathRunner
local.input=input
local.output=output
# Pseudo-Cluster Execution
hdfs.user.name=AnantShanbhag
hdfs.input=input
hdfs.output=output
# AWS EMR Execution
aws.emr.release=emr-5.17.0
aws.region=us-east-1
aws.bucket.name=sssp-8m
